...
class GeminiService:
    ...
    def _construir_prompt_situacion(self, datos):
        ...
        **Producto:** {datos.get('producto_final', '')}
        ...
        - Debes generar la 'Situación de Aprendizaje' con 8 puntos, y el Punto 7: Actividades del Alumnado debe ser la sección más extensa, utilizando una lista con al menos 4 actividades claras. TU TAREA MÁS IMPORTANTE ES COMPLETAR ÍNTEGRAMENTE EL DOCUMENTO, INCLUYENDO EL PUNTO 7 Y EL PUNTO 8, SIN DETENERTE POR NINGÚN MOTIVO.ES CRUCIAL QUE NO TE DETENGAS antes de terminar el último punto
        """
        return prompt
